...
public class Exercise6 {
	...
	protected static String pegarInformacao(Scanner input, String mensagem) {
	...
	protected static int pegarInformacaoInt(Scanner input, String mensagem) {
		System.out.println(mensagem);
		String saida = input.nextLine();
	...
	protected static Contato pegarDadosContato(Scanner input) {
	...
	//Print the menu
	protected static int menu(Scanner input) {
		boolean validacao = false;
		int escolha = 0;
		String saida;
		...
		while(!validacao) {
			...
			System.out.println("2: Adicionar contato em uma posicao");
			...
			System.out.println("7: Remover contato especifico");
